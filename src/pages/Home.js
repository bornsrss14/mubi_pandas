  ...
  const usrRef = useRef(null);
  {
    ...
    return (
      <div>
        ...
        <section className="div-new-on-mubi section-persentage">
          ...
          >
            ...
            <div className="ratingAndDate">
              {" "}
              <Rating noStars={5} widthContainer="40%"></Rating>
              <p>4 Agu</p>
            </div>
          </PosterMovie>
          <PosterMovie
          ...
          >
            ...
            <div className="ratingAndDate">
              {" "}
              <Rating noStars={3} widthContainer="40%"></Rating>
              <p>4 Agu</p>
            </div>
          </PosterMovie>
          ...
          >
            ...
            <div className="ratingAndDate">
              {" "}
              <Rating noStars={4} widthContainer="40%"></Rating>
              <p>4 Agu</p>
            </div>
          </PosterMovie>
          <PosterMovie
        ...
        <section className="section-persentage"></section>
      </div>
    );
  }
};
